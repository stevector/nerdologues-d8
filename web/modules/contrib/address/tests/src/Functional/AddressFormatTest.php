 ...
 * @group address
 */
class AddressFormatTest extends BrowserTestBase {
  ...
  function testAddressFormatImport() {
    ...
    $this->assertEquals($external_count, $count, 'All address formats imported at installation.');
  }
  ...
  function testAddressFormatEditing() {
    ...
    $address_format = AddressFormat::load($country_code);
    $this->assertEquals($address_format->getPostalCodeType(), $new_postal_code_type, 'The address format PostalCodeType has been changed.');
  }
