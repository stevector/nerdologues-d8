Feature: Clip creation
  ...
  Scenario: Clip nodes created for each list item in a your stories podcast
    ...
    And I fill in "Title" with "My New Episode"
    And I fill in "Body" with "<p>Maybe it seems weird</p><ul><li>Homer: The Odyssey</li><li>Mary Shelley:Frankenstein</li></ul>"
    And I check the box "Publishing status"
    And I press "Save"
    Then I visit "admin/content"
    Then I should see the link "Homer: The Odyssey"
    And I click "Mary Shelley:Frankenstein"
    Then I should see the link "Your Stories" in the "From the podcast" region
    Then I should see the link "My New Episode" in the "From the episode" region
