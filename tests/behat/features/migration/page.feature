Feature: Page
  ...
  Scenario: Page nodes
    ...
    | Album                                                 | Basic page   | public://field_image/page/Nerdologues002.jpg                        |            |
    | Fisticuffs! Rules                                     | Basic page   |                                                                     | Fisticuffs |     | Fisticuffs! FAQ                                       | Basic page   | public://field_image/page/Screen Shot 2015-08-28 at 10.39.04 AM.png | Fisticuffs |
